...
//outside of tests- mock 
jest.mock('./api/fetchShow')

//test needs to render App, click on the 'get data' button
//assert that data is rendered - AFTER the api fetch is completed



test('renders data after API is called', async () => {
    mockFetchShow.mockResolvedValueOnce(dummyData.data);

    console.log(mockFetchShow.mockResolvedValueOnce(dummyData.data));
